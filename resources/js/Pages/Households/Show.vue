            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-6 items-start">
                    ...
                    <div class="bg-white p-6 shadow sm:rounded-lg">
                        ...
                        <ul>
                            <li v-for="member in household.users" :key="member.id" class="py-2 border-b last:border-0">
                    ...
                    <div class="bg-white p-6 shadow sm:rounded-lg">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <Link :href="route('households.expenses.create', household.id)" class="bg-indigo-600 text-white px-3 py-1.5 rounded-md text-sm hover:bg-indigo-700">
                                + Add Expense
                            </Link>
                        </div>
                        ...
                        <div v-for="expense in expenses" :key="expense.id" class="border-b last:border-0 py-3">
                            ...
                            <div class="mt-2 space-y-1">
                                <div v-for="split in expense.splits" :key="split.id" class="flex justify-between text-sm">
